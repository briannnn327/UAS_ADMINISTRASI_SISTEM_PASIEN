...
<head>
    ...
    <title>Login — Klinik Gen-Z</title>
...
<body>
    ...
    <div class="login-card">
        ...
        <div class="text-center mb-8">
            ...
            <h1 class="text-2xl font-extrabold text-gray-900">Masuk ke Klinik Gen-Z</h1>
        ...
        <form method="POST" action="{{ route('login') }}" novalidate>
            ...
            <div class="input-group">
                ...
                <button type="button" class="toggle-pwd" onclick="togglePwd('pwd','eye')">
