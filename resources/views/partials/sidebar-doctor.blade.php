...
<aside class="hidden md:flex flex-col w-64 min-h-screen bg-gradient-to-b from-primary-dark to-primary shrink-0">
    <div class="p-4 m-3 bg-white/10 rounded-2xl text-center">
        ...
        <div class="text-white/60 text-xs uppercase tracking-wider mt-0.5">Dokter</div>
    </div>
    ...
    <nav class="px-3 pb-4 flex flex-col gap-1">
        @php
            $links = [
                ...
                ['route' => 'doctor.schedule', 'icon' => 'fa-calendar', 'label' => 'Jadwal Saya'],
                ['route' => 'doctor.patients.index', 'icon' => 'fa-users', 'label' => 'Pasien Hari Ini'],
                ['route' => 'doctor.history', 'icon' => 'fa-clock-rotate-left', 'label' => 'Riwayat Pasien'],
            ];
        @endphp
